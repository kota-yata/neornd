                    ...
                    if ('string' == typeof i) {
                      ...
                      if ((this._log('\nCheck Matches: '.concat(P)), (g || k.isMatch) && P)) {
                        ...
                        F
                          ...
                          : ((d[s] = {
                              item: a,
                              output: [{ key: r, arrayIndex: o, value: i, score: j, matchedIndices: k.matchedIndices }],
                            }),
                            p.push(d[s]));
                      }
                    } else if (E(i))
                    ...
                    n.push(function (e, t) {
                      ...
                      for (var n = 0, o = r.length; n < o; n += 1) {
                        ...
                        if (0 !== i.matchedIndices.length) {
                          ...
                          i.key && (a.key = i.key),
                            i.hasOwnProperty('arrayIndex') && -1 < i.arrayIndex && (a.arrayIndex = i.arrayIndex),
                            t.matches.push(a);
                        }
                      }
                    }),
      ...
      function (e, t, r) {
        ...
        e.exports = function (e, t, r, n) {
          ...
          for (var M = [], _ = 1, L = m + p, w = 1 << (m - 1), A = 0; A < m; A += 1) {
            for (var C = 0, I = L; C < I; )
              E(t, { errors: A, currentLocation: v + I, expectedLocation: v, distance: s }) <= g ? (C = I) : (L = I),
            ...
            for (var F = j; O <= F; F -= 1) {
              ...
              if (
                ...
                P[F] & w && (_ = E(t, { errors: A, currentLocation: T, expectedLocation: v, distance: s })) <= g)
              ) {
                if (((g = _), (y = T) <= v)) break;
                O = Math.max(1, 2 * v - y);
              }
