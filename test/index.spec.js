...
describe('Min Check', () => {
  for (let i = 0; i < 100; i++) {
    ...
    it('3rd arg is maximum : 1-2-16', () => {
      chai.assert.isAtLeast(neornd.get(1, 2, 16), 1);
    });
  }
});
...
describe('Max Check', () => {
  for (let i = 0; i < 100; i++) {
    ...
    it('3rd arg is maximum : 1-2-16', () => {
      chai.assert.isAtMost(neornd.get(1, 2, 16), 2);
    });
  }
});
...
describe('Error Detection', () => {
  for (let i = 0; i < 100; i++) {
    ...
    it('Error! 3rd arg is greater than maximum number : -1-2-17', () => {
      chai.assert.deepEqual(neornd.get(-1, 2, 17), NaN);
    });
